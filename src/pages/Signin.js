...
const SignIn = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-100 to-gray-200 dark:from-gray-900 dark:to-indigo-950 transition-colors duration-300">
      <motion.div
